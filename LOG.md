...
**Resource:** InsiderPhD Video
**Learnings:**
* Configured FoxyProxy to route traffic to 127.0.0.1:8080.
* Successfully intercepted my first request.
* Explored the "Repeater" tab—it's like a manual API testing tool on steroids.
